...
echo "sensor_scullery_motion: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_temperature: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_humidity: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_luminance: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_alarm_level: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_alarm_type: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_source_nodeid: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
echo "sensor_scullery_ultraviolet: dummy" >> $TRAVIS_BUILD_DIR/secrets.yaml
