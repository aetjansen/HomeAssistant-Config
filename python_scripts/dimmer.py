################################################################
## python_script / Dimmer
################################################################
## Python script to use as a service to change light brightness
## and then dim back to previously remembered states
################################################################
## Taken from: https://community.home-assistant.io/t/brighten-a-light-then-return-to-previous-brightness-state/20802
################################################################
